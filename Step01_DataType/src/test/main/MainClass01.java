...
public class MainClass01 {
	public static void main(String[] args) {
		System.out.println("main 메소드가 시작되었습니당");
		 ...
		 *  - 표현 가능 범위가 좁은 변수에 담긴 값을 표현 가능 범위가 더 넓은 변수에 대입하는 것은 문제가 없음
		 *  - 따라서, 에러를 발생시키지 않음
		 */
		int tmp = iShort;
		...
		float num1 = 10.1f;
		double num2 = 10.2d;
		double num3 = 10.3;	//d, f를 붙이지 않으면 double type으로 간주됨
		...
		System.out.println("main 메소드가 종료됩니당");
